...
// 描述: “趣乐兔”专属前端插件，纯搜索功能 - 最终修复版 (回退到可靠的 PNG 占位图)
...
// ★★★ 核心修复：使用可靠的 PNG 格式占位图 URL ★★★
// 采用 180x270 尺寸，深色背景，白色中文文字
const PLACEHOLDER_PIC = "https://placehold.co/180x270/1f2937/ffffff/png?text=趣乐兔+资源"; 
